...
import com.proteus.parser.code_coverage.gen.CCoverageParser.IdentifierListContext;

public class IdentifierListContextExt extends AbstractBaseExt{

	@Getter private IdentifierListContext ctx;
	...
	public void setContext(ParserRuleContext ctx){
		if(ctx != null){
			if(ctx instanceof IdentifierListContext){
				this.ctx = (IdentifierListContext) ctx;
			} else {
